...
public class TMLocalizacaoProduto extends AbstractTableModel {

	private List<LocalizacaoProduto> dados;
	...
	public TMLocalizacaoProduto() {
		dados = new ArrayList<LocalizacaoProduto>();

	}

	public void addRow(LocalizacaoProduto p) {
