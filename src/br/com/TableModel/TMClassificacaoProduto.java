...
public class TMClassificacaoProduto extends AbstractTableModel {

	private List<ClassificacaoProduto> dados;
	...
	public TMClassificacaoProduto() {
		dados = new ArrayList<ClassificacaoProduto>();

	}

	public void addRow(ClassificacaoProduto p) {
